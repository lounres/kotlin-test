...
operator fun <T: Ring<T>> LabeledRationalFunction<T>.plus(other: RationalFunction<T>) =
    LabeledRationalFunction(
        numerator * other.denominator.toLabeledPolynomial() + denominator * other.numerator.toLabeledPolynomial(),
        denominator * other.denominator.toLabeledPolynomial()
    )
...
operator fun <T: Ring<T>> LabeledRationalFunction<T>.minus(other: RationalFunction<T>) =
    LabeledRationalFunction(
        numerator * other.denominator.toLabeledPolynomial() - denominator * other.numerator.toLabeledPolynomial(),
        denominator * other.denominator.toLabeledPolynomial()
    )
...
operator fun <T: Ring<T>> LabeledRationalFunction<T>.times(other: RationalFunction<T>) =
    LabeledRationalFunction(
        numerator * other.numerator.toLabeledPolynomial(),
        denominator * other.denominator.toLabeledPolynomial()
    )
...
operator fun <T: Ring<T>> LabeledRationalFunction<T>.div(other: RationalFunction<T>) =
    LabeledRationalFunction(
        numerator * other.denominator.toLabeledPolynomial(),
        denominator * other.numerator.toLabeledPolynomial()
    )
